    ...
    <div className="mt-4 pt-4 border-t border-gray-200">
      <div className="flex flex-col space-y-3 sm:space-y-3">
        ...
        <div className="flex justify-center space-x-2 sm:space-x-4">
          <div className="h-5 w-8 sm:h-6 sm:w-10 bg-gray-100 rounded flex items-center justify-center">
          ...
          <div className="h-5 w-8 sm:h-6 sm:w-10 bg-gray-100 rounded flex items-center justify-center">
            <svg viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24" aria-labelledby="pi-american_express">
          ...
          <div className="h-5 w-8 sm:h-6 sm:w-10 bg-gray-100 rounded flex items-center justify-center">
            <svg viewBox="0 0 38 24" width="38" height="24" role="img" aria-labelledby="pi-discover" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M20.16 12.86a2.931 2.931 0 100-5.862 2.931 2.931 0 000 5.862z" fill="#F48120"></path>
            </svg>
          </div>
        </div>
